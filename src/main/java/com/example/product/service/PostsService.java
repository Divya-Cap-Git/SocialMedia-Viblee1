...
public interface PostsService {
	PostsDto2 createPost(Posts post,int userid) throws UserNotFoundException;
	PostsDto2 getPostById(int postId)throws PostsNotFoundException ;
