...
public interface UsersService {
  ...
  void deleteUser(int userId) throws UserNotFoundException;
   ...
   List<Comments> getAllCommentsInPostByUser(int userId) throws UserNotFoundException;
   ...
   List<MessageDto> getAllMessageBetweenUser(int send,int received)throws UserNotFoundException;
   ...
   List<UsersDto> getRandomUsers(int userid) throws UserNotFoundException;
   
   String AcceptFriend(int userId,int friendshipId,int otherUserId)throws UserNotFoundException;
   
   String addNotifications(int UserId, String notifications)throws  UserNotFoundException;
